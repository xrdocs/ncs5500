...
We will use “redistribute connected” under VRF to advertise connected routes via BGP. In addition, we are going to configure BGP multipathing/aliasing for load balancing where multiple next-hops are available for the same prefix. 
