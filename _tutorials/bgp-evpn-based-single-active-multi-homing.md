...
**Note:** As Leaf-2 sees Host-1's MAC reachable via Leaf-1, if another Host/ESI connected to Leaf-2 wants to reach to Host-1 it will have to go over Leaf-1 to reach to Host-1.
