...
We are using a mix of routers across the NCS540 portfolio as the PEs and WAN core routers. CE IR8340 is a substation router connected to an RTU and CE ASR-1002 headend router is connected to the control centre. 
